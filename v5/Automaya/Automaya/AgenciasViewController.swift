//
//  AgenciasViewController.swift
//  Automaya
//
//  Created by jmvarguez on 7/13/15.
...
class AgenciasViewController: UIViewController, CLLocationManagerDelegate, GMSMapViewDelegate  {
...
/******************************************************/
    ...
    override func viewDidLoad() {
        ...
        let camera: GMSCameraPosition = GMSCameraPosition.cameraWithLatitude(20.992557, longitude: -89.6164583, zoom: 18.0)
        ...
        // Do any additional setup after loading the view.20.992557,-89.6164583
    }
    ...
    override func observeValueForKeyPath(keyPath: String, ofObject object: AnyObject, change: [NSObject : AnyObject], context: UnsafeMutablePointer<Void>) {
        if !didFindMyLocation {
            ...
            viewMap.camera = GMSCameraPosition.cameraWithTarget(myLocation.coordinate, zoom: 5.0)
    ...
    @IBAction func findAddress(sender: AnyObject) {
        let addressAlert = UIAlertController(title: "Buscador de Dirección", message: "Escriba la dirección que desea buscar:", preferredStyle: UIAlertControllerStyle.Alert)
        
        addressAlert.addTextFieldWithConfigurationHandler { (textField) -> Void in
            textField.placeholder = "Dirección?"
        }
        
        let findAction = UIAlertAction(title: "Buscar Dirección", style: UIAlertActionStyle.Default) { (alertAction) -> Void in
            ...
            self.mapTasks.geocodeAddress(address, withCompletionHandler: { (status, success) -> Void in
                if !success {
                    ...
                    if status == "ZERO_RESULTS" {
                        self.showAlertWithMessage("La ubicación no se pudo encontrar.")
                    }
                }
                else {
        ...
        let closeAction = UIAlertAction(title: "Cerrar", style: UIAlertActionStyle.Cancel) { (alertAction) -> Void in
    ...
    @IBAction func createRoute(sender: AnyObject) {
        let addressAlert = UIAlertController(title: "Crear ruta", message: "Conecte lugares con una ruta:", preferredStyle: UIAlertControllerStyle.Alert)
        
        addressAlert.addTextFieldWithConfigurationHandler { (textField) -> Void in
            textField.placeholder = "Origen?"
        }
        ...
        let createRouteAction = UIAlertAction(title: "Crear ruta", style: UIAlertActionStyle.Default) { (alertAction) -> Void in
