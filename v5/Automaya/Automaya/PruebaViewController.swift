...
class PruebaViewController: UIViewController {
    ...
    @IBAction func signupTapped(sender: AnyObject) {
        ...
        if ( nomuser.isEqualToString("") ) {
            ...
            var post:NSString = "nombre=\(nomuser)&email=\(emailuser)&telefono=\(teluser)&fechacita=\(fechauser)&tpservicio=prueba&marca=\(marcauser)&modelo=\(modelouser)&accion=EnViar"
