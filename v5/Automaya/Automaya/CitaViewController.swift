...
//  Automaya
//
//  Created by jmvarguez on 7/25/15.
...
class CitaViewController: UIViewController {
    ...
    @IBAction func signupTapped(sender: AnyObject) {
        ...
        if ( nomuser.isEqualToString("") ) {
            ...
            var post:NSString = "nombre=\(nomuser)&email=\(emailuser)&telefono=\(teluser)&fechacita=\(fechauser)&tpservicio=servicio&marca=\(marcauser)&modelo=\(modelouser)&accion=EnViar"
